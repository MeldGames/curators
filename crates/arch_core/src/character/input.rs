...
// pub fn dig_target(
//     trigger: Trigger<Fired<Dig>>,
//     mut players: Query<(&GlobalTransform, &mut DigState, &Collider)>,
//     mut voxels: Query<(Entity, &GlobalTransform, &mut Voxels)>,
//     time: Res<Time>,
//     mut gizmos: Gizmos,
// ) {
//     let Ok((global_transform, mut state, collider)) = players.get_mut(trigger.target()) else {
//         return;
//     };
